    ...
    try {
        ...
        app.post('/borrow/:id', async (req, res) => {
            ...
            try {
                ...
                // Including price from `bookCollection` to ensure it’s saved in `borrowCollection`
                const borrowResult = await borrowCollection.insertOne({
                    ...
                    image,
                    category,
                    price: book.price // ensure price is stored here from book data
                });
        ...
        app.get('/borrowed/:email', async (req, res) => {
            ...
            try {
                ...
                res.json(borrowedBooks); // each book document now contains price
            } catch (error) {
